...
use app\models\LeavebillSerach;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * Leavebill2Controller implements the CRUD actions for Leavebill model.
 */
class Leavebill2Controller extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new LeavebillSerach();
