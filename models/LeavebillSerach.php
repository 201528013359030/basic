 ...
 */
class LeavebillSerach extends Leavebill
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'userid', 'leaveType', 'leaveStartTime', 'leaveEndTime', 'reason', 'remark', 'applyTime', 'username', 'days', 'dep', 'spuser', 'tzuser', 'tongzhi', 'token', 'approvalPerson'], 'safe'],
            [['state'], 'integer'],
        ];
    }
