				...
				<div class="row">
			        ...
			        <div class="small-9 columns">
			          <select data-invalid aria-invalid="true" required name="leaveType" >
				          ...
				          <option value="1" <s:if test="#bill.leaveType==1">selected="selected"</s:if> >事假</option>
				          <option value="2" <s:if test="#bill.leaveType==2">selected="selected"</s:if> >病假</option>
				          <option value="3" <s:if test="#bill.leaveType==3">selected="selected"</s:if> >婚假</option>
				          <option value="4" <s:if test="#bill.leaveType==4">selected="selected"</s:if> >丧假</option>
				          <option value="5" <s:if test="#bill.leaveType==5">selected="selected"</s:if> >年假</option>
				          <option value="6" <s:if test="#bill.leaveType==6">selected="selected"</s:if> >其他</option>
				        </select>
