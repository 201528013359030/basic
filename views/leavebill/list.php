...
<!-- 	  				<s:else> -->
					...
					<p class="info clearfix">
						<span class="fl name"> <!-- 	  					<s:property value="day"/> -->
						<?= Html::encode($disagree['days'])?>
	  					</span> <span class="fr status"> <!-- 	  						<s:if test="state==1"> -->
						<?php if($disagree['state']==1){?>
	  							<em class="fc_sucess">审批中</em> <!-- 	  						</s:if> -->
						<?php }elseif ($disagree['state']==2){?>
<!-- 	  						<s:elseif test="state==2"> --> <em class="fc_sucess">同意</em>
							<!-- 	  						</s:elseif> -->
						<?php }elseif($disagree['state']==3){?>
<!-- 	  						<s:elseif test="state==3"> --> <em class="fc_error">拒绝</em>
							<!-- 	  						</s:elseif> -->
						<?php }elseif($disagree['state']==4){?>
<!-- 	  						<s:else> --> <em class="fc_sucess">放弃</em> <!-- 	  						</s:else> -->
						<?php }?>
	  					</span>
					</p>
					<p class="info clearfix">
...
<!-- 	  				<s:else> -->
				...
				<?php }?>
	  				<i class="ficon icon-angle-right"></i>
					<p class="info clearfix">
						<span class="fl name"> <!-- 	  					<s:property value="username"/> -->
			<?=Html::encode($disapproval['username'])?>
	  					</span> <span class="fr status"><em class="fc_sucess">待审批</em></span>
					</p>
					<p class="info clearfix">
