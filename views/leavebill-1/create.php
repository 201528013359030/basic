...
<div class="off-canvas-wrap" data-offcanvas>
	...
	<div class="row">
		<form  data-abide action="http://localhost/basic/web/index.php?r=leavebill/create"  method="get">
...
<!-- 			          <input class="hid-input" value="qqq" type="text" name="name" required /> -->
<!-- 			          <small class="error">请选择审批人</small> -->
<!-- 			        </div> -->
<!-- 			    </div> -->
<!-- 				<div class="row"> -->
...
<!-- 			          <input class="hid-input" value="www"  type="text" name="" required /> -->
<!-- 			          <small class="error">请选择通知人</small> -->
<!-- 			        </div> -->
...
<!-- 			    </div> -->
				<div class="row">
			        ...
			        <div class="small-9 columns">
			          <textarea onpropertychange="this.style.height=this.scrollHeight + 'px'" oninput="this.style.height=this.scrollHeight + 'px'" name= "ffff" placeholder="请输入请假事由" required></textarea>
